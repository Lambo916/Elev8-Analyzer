...
(function (ns) {
  ...
  ns.drawFooter = function drawFooter(doc, pageNumber, pageCount) {
    ...
    const footer = `Generated by GrantGenie   Page ${pageNumber} of ${pageCount}`;
...
(() => {
  ...
  function getToolkitName() {
    return window.currentToolkitName || "GrantGenie";
  }
  ...
  async function drawFooter(doc, pageNum, totalPages) {
    ...
    doc.text("Generated by GrantGenie", CONTENT.left, mainFooterY);
